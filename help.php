...
<p>1. To integrate with Google Analytics go to the <code><b>Google Analytics</b></code> tab and click <code><b>Log in with Google Analytics Account</b></code> button.
</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/images/screenshot-1.png"?>" alt="GoogleAnalytics1"></p>

<p>2. Follow the steps and give 51Degrees plugin the required permissions and copy the provided Google Analytics <code><b>Access Code</b></code> in the end.
</p>
...
<p>4. After authentication, use the drop down box to select which Google Analytics Account and Property you want to enable custom dimensions for. Check <code><b>Send Page View</b></code> if you want to send Default Page View hit along with your custom dimensions. It is only recommended if you have not already integrated with any other Google Analytics plugin to avoid duplication. Click <code><b>Save Changes</b></code>.
</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/images/screenshot-4.png"?>" alt="GoogleAnalytics4"></p>

<p>5. This will prompt to the new custom dimensions screen where you can find all the custom dimensions available with your resource key. Click on Enable Google Analytics Tracking button to enable tracking of all the Device Data Properties as custom dimensions.
</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/images/screenshot-5.png"?>" alt="GoogleAnalytics5"></p>
