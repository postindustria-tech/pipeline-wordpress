...
<p>For example, the text <code>{fiftyonedegrees::get(&quot;device&quot;, &quot;browsername&quot;)}</code> would be replaced with <code>Chrome</code>, <code>Safari</code>, <code>Firefox</code>, etc. Depending on the browser being used by the person visiting your site.</p>
<p>In this case, we display the vendor, name and version number of the client&#39;s browser:</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/property-example.png"?>" alt="ValueReplacementExample1"></p>
<p>To set this up, we take the text from the &#39;Usage in Content&#39; column on the &#39;properties&#39; page of the plugin:</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/properties-in-content.png"?>" alt="ValueReplacementExample2"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/conditional-block-1.png"?>" alt="ConditionalBlockExample1"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/conditional-block-2.png"?>" alt="ConditionalBlockExample2"></p>
...
<pre>fiftyonedegrees::get("device", "ismobile")</pre>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/location-1.png"?>" alt="LocationExample1"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/location-2.png"?>" alt="LocationExample2"></p>
...
&lt;/script&gt;
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/location-3.png"?>" alt="LocationExample3"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/location-4.png"?>" alt="LocationExample4"></p>
<p>After the button is clicked, we need to make another request to the server for the location values to be populated:</p>
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/location-5.png"?>" alt="LocationExample5"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/apple-device-1.png"?>" alt="AppleExample1"></p>
...
<p><img src="<?php echo plugin_dir_url( __FILE__ ) . "assets/static/apple-device-2.png"?>" alt="AppleExample2"></p>
